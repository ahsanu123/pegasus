...
namespace WingtipToys.CustomControl
{
            ...
            IRenderOuterTableControl
    {
        ...
        /// </devdoc>
        [WebCategory("Paging"), DefaultValue(false), WebSysDescription(SR.FormView_AllowPaging)]
        ...
        /// </devdoc>
        [WebCategory("Layout"), DefaultValue(-1), WebSysDescription(SR.FormView_CellPadding)]
        ...
        /// </devdoc>
        [WebCategory("Layout"), DefaultValue(0), WebSysDescription(SR.FormView_CellSpacing)]
        ...
        /// </devdoc>
        [WebCategory("Action"), WebSysDescription(SR.FormView_OnPageIndexChanged)]
        ...
        /// </devdoc>
        [WebCategory("Action"), WebSysDescription(SR.FormView_OnPageIndexChanging)]
        ...
        /// </devdoc>
        [WebCategory("Action"), WebSysDescription(SR.FormView_OnItemCommand)]
        ...
        /// </devdoc>
        [WebCategory("Behavior"), WebSysDescription(SR.FormView_OnItemCreated)]
        ...
        /// </devdoc>
        [WebCategory("Action"), WebSysDescription(SR.FormView_OnModeChanged)]
        ...
        /// </devdoc>
        [WebCategory("Action"), WebSysDescription(SR.FormView_OnModeChanging)]
            ...
            else
            {
                ...
                if (dataSource != null)
                {
                    if (mode != FormViewMode.Insert)
                    {
                        ...
                        {
                            throw new HttpException(
                                SR.GetString(SR.FormView_DataSourceMustBeCollection, ID)
                            );
                        }
        ...
        private FormViewRow CreateDataRow(
            bool dataBinding,
        ...
        )
        {
            ...
            if (addFirstLastPageButtons && !isFirstPage)
            {
                ...
                if (firstPageImageUrl.Length > 0)
                {
                    ...
                    ((ImageButton)firstButton).AlternateText = HttpUtility.HtmlDecode(
            ...
            if (!isFirstPage)
            {
                ...
                if (prevPageImageUrl.Length > 0)
                {
                    ...
                    ((ImageButton)prevButton).AlternateText = HttpUtility.HtmlDecode(
            ...
            if (!isLastPage)
            {
                ...
                if (nextPageImageUrl.Length > 0)
                {
                    ...
                    ((ImageButton)nextButton).AlternateText = HttpUtility.HtmlDecode(
            ...
            if (addFirstLastPageButtons && !isLastPage)
            {
                ...
                if (lastPageImageUrl.Length > 0)
                {
                    ...
                    ((ImageButton)lastButton).AlternateText = HttpUtility.HtmlDecode(
        ...
        protected virtual void ExtractRowValues(IOrderedDictionary fieldValues, bool includeKeys)
        {
            if (fieldValues == null)
            {
                Debug.Assert(
                    false,
                    "FormView::ExtractRowValues- must hand in a valid reference to an IDictionary."
                );
                return;
            }
            ...
            if (Mode == FormViewMode.ReadOnly && ItemTemplate != null)
            {
                ...
                (
                    Mode == FormViewMode.Edit
                    || (Mode == FormViewMode.Insert && InsertItemTemplate == null)
                )
        ...
        private void HandleInsert(string commandArg, bool causesValidation)
        {
            ...
            {
                throw new HttpException(
                    SR.GetString(SR.DetailsViewFormView_ControlMustBeInInsertMode, "FormView", ID)
                );
            }
        ...
        private void HandleUpdate(string commandArg, bool causesValidation)
        {
            ...
            {
                throw new HttpException(
                    SR.GetString(SR.DetailsViewFormView_ControlMustBeInEditMode, "FormView", ID)
                );
            }
        ...
        public virtual bool IsBindableType(Type type)
        {
            ...
            return DataBoundControlHelper.IsBindableType(
                type,
                enableEnums: this.RenderingCompatibility >= VersionUtil.Framework45
            );
        }
        ...
        protected virtual void OnPageIndexChanging(FormViewPageEventArgs e)
        {
            ...
            FormViewPageEventHandler handler = (FormViewPageEventHandler)
            ...
            else
            {
                ...
                {
                    throw new HttpException(
                        SR.GetString(SR.FormView_UnhandledEvent, ID, "PageIndexChanging")
                    );
                }
            }
        }
        ...
        {
            FormViewCommandEventHandler handler = (FormViewCommandEventHandler)
        ...
        {
            FormViewDeletedEventHandler handler = (FormViewDeletedEventHandler)
        ...
        protected virtual void OnItemDeleting(FormViewDeleteEventArgs e)
        {
            ...
            FormViewDeleteEventHandler handler = (FormViewDeleteEventHandler)
            ...
            else
            {
                ...
                {
                    throw new HttpException(
                        SR.GetString(SR.FormView_UnhandledEvent, ID, "ItemDeleting")
                    );
                }
            }
        }
        ...
        {
            FormViewInsertedEventHandler handler = (FormViewInsertedEventHandler)
        ...
        protected virtual void OnItemInserting(FormViewInsertEventArgs e)
        {
            ...
            FormViewInsertEventHandler handler = (FormViewInsertEventHandler)
            ...
            else
            {
                ...
                {
                    throw new HttpException(
                        SR.GetString(SR.FormView_UnhandledEvent, ID, "ItemInserting")
                    );
                }
            }
        }
        ...
        {
            FormViewUpdatedEventHandler handler = (FormViewUpdatedEventHandler)
        ...
        protected virtual void OnItemUpdating(FormViewUpdateEventArgs e)
        {
            ...
            FormViewUpdateEventHandler handler = (FormViewUpdateEventHandler)
            ...
            else
            {
                ...
                {
                    throw new HttpException(
                        SR.GetString(SR.FormView_UnhandledEvent, ID, "ItemUpdating")
                    );
                }
            }
        }
        ...
        protected virtual void OnModeChanging(FormViewModeEventArgs e)
        {
            ...
            else
            {
                ...
                {
                    throw new HttpException(
                        SR.GetString(SR.FormView_UnhandledEvent, ID, "ModeChanging")
                    );
                }
            }
        }
            ...
            else
            {
                ...
                if (!string.IsNullOrEmpty(propertyName))
                {
                    throw new InvalidOperationException(
                        SR.GetString(
                            SR.IRenderOuterTableControl_CannotSetStyleWhenDisableRenderOuterTable,
                            propertyName,
                            GetType().Name,
                            ID
                        )
